...
*/
	...
	$wp_styles->add_data('ie10', 'conditional', 'lte IE 10');

	wp_enqueue_style('ie9');
	$wp_styles->add_data('ie9', 'conditional', 'let IE 9');
...
function bones_main_nav() {
    ...
    wp_nav_menu(array(
    	...
    	'menu_class' => 'nav top-nav large-9 columns',         // adding custom nav class
...
function bones_main_nav_fallback() {
	wp_page_menu( array(
		'show_home' => true,
    	'menu_class' => 'nav top-nav something',      // adding custom nav class
		'include'     => '',
		'exclude'     => '',
		'echo'        => true,
        'link_before' => '',                            // before each link
